...
//		int su1, su2, min=0, num, pl=1;
//		System.out.print("수 입력 : ");
//		su1 = sc.nextInt();
//		System.out.print("수 입력 : ");
//		su2 = sc.nextInt();
//		for(int i=1;i<=su1 && i<=su2;i++){
//			if(su1%i==0 && su2%i==0)
//				min=i;
//		}
...
//				sum+=i;
//				System.out.println();
//				System.out.println("4,6으로 나누어도 나머지 1인 수 : " + i);
//				System.out.println("4,6으로 나누어도 나머지 1인 수의 합 : " + sum);
//			}
//		}
//		System.out.println("4,6으로 나누어도 나머지 1인 수의 합 : " + sum);
